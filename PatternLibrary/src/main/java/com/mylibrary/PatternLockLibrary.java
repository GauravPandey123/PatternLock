...
public class PatternLockLibrary extends ViewGroup {
    ...
    public PatternLockLibrary(Context context) {
        this(context, null);
    }

    public PatternLockLibrary(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PatternLockLibrary(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public PatternLockLibrary(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initFromAttributes(AttributeSet attrs, int defStyleAttr) {
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.PatternLockLibrary, defStyleAttr, 0);

        nodeSrc = a.getDrawable(R.styleable.PatternLockLibrary_nodeSrc);
        nodeOnSrc = a.getDrawable(R.styleable.PatternLockLibrary_nodeOnSrc);
        int lineColor = Color.argb(0, 0, 0, 0);
        lineColor = a.getColor(R.styleable.PatternLockLibrary_lineColor, lineColor);
        float lineWidth = 20.0f;
        lineWidth = a.getDimension(R.styleable.PatternLockLibrary_lineWidth, lineWidth);
