...
public class ChangeActivity extends ActionBarActivity {
	...
	private PatternLockLibrary lockViewFirstTry, lockViewConfirm;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lockViewFirstTry = (PatternLockLibrary) findViewById(R.id.lock_viewFirstTry);
		lockViewConfirm =  (PatternLockLibrary) findViewById(R.id.lock_viewConfirm);

//		we can get a call back string when ever user interacts with the pattern lock view
		lockViewFirstTry.setCallBack(new PatternLockLibrary.CallBack() {
		...
		lockViewConfirm.setCallBack(new PatternLockLibrary.CallBack() {
